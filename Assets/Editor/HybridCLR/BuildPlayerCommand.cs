...
namespace HybridCLR.Editor
{
    public class BuildPlayerCommand
    {
        ...
        public static void Build_Win64(bool existWhenCompleted)
        {
            ...
            // Get filename.
            string outputPath = $"{SettingsUtil.ProjectDir}/Builds/Release-Win64";

            var buildOptions = BuildOptions.CompressWithLz4;

            string location = $"{outputPath}/HybridCLRQuickStart.exe";
            ...
            BashUtil.CopyDir(Application.streamingAssetsPath, $"{outputPath}/HybridCLRQuickStart_Data/StreamingAssets", true);
        }
    }
}